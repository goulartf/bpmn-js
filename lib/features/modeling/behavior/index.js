...
import ConnectEventBasedGatewayToReceiveTaskWithBoundaryBehavior from './ConnectEventBasedGatewayToReceiveTaskWithBoundaryBehaviour';
...
export default {
  __init__: [
    ...
    'appendBehavior',
    'connectEventBasedGatewayToReceiveTaskWithBoundaryBehavior',
    'copyPasteBehavior',
  ...
  connectEventBasedGatewayToReceiveTaskWithBoundaryBehavior: [ 'type', ConnectEventBasedGatewayToReceiveTaskWithBoundaryBehavior ],
